...
<body>
    ...
    <div class="mainindex">   
		...
		<div class="xline"></div>
<form name="xg_form" id="xg_form"  method="post" action="system_action.php?action=change&&tnumber={$tnumber}" style="margin-left:350px">
	...
	<tr>
		<td width="22%">
			...
			<td>
		    <div align="left" >
		      <input name="s_xh" id="s_xh" type="text" class="dfinput" value="{$tnumber}"  style="width:345px; " disabled />
		   </div>
