...
<body style="background-color:#F2F0F1; ">
	<div class="welinfo">
		<span style="margin-left:15px;margin-top:6px;cursor:pointer;"><a href="bbs_list.php?snumber={$snumber}&&course_id={$course_id}&&action=list&&pageNum=1"><img src="../../tools/images/back.png"  title="点击返回主题列表" /></a></span>
		 ...
		 <div id="collapse-panel-zhuti" class="am-panel-bd am-collapse">
            <ul class="am-list admin-content-task">			     
					<li style="width:895px;margin-left:30px;height:30px">  	
						<form id="rep_form" name="rep_form" method="post" action="bbs_list.php?action=rep&&snumber={$snumber}&&course_id={$course_id}">
	   ...
	   <!---循环结束- {/section}---->
		...
		<div style="margin-right:5px">
			   <ul class="am-pagination am-fr admin-content-pagination" >
				  <li class="{$sty[0]}"><a href="bbs_list.php?action=detial&&id={$data[0][1]}&&pageNum=1&&idf=0&&snumber={$snumber}&&course_id={$course_id}">首页</a></li>
				  <li class="{$sty[0]}"><a href="bbs_list.php?action=detial&&id={$data[0][1]}&&pageNum={$left}&&idf=0&&snumber={$snumber}&&course_id={$course_id}">&laquo;</a></li>
				  <li class="{$sty[6]}"><a href="bbs_list.php?action=detial&&id={$data[0][1]}&&pageNum={$pageNum}&&idf=0&&snumber={$snumber}&&course_id={$course_id}">{$pageNum}</a></li>
				  <li class="{$sty[1]}"><a href="bbs_list.php?action=detial&&id={$data[0][1]}&&pageNum={$pageNum+1}&&idf=0&&snumber={$snumber}&&course_id={$course_id}">{$pageNum+1}</a></li>
				  <li class="{$sty[2]}"><a href="bbs_list.php?action=detial&&id={$data[0][1]}&&pageNum={$pageNum+2}&&idf=0&&snumber={$snumber}&&course_id={$course_id}">{$pageNum+2}</a></li>
				  <li class="{$sty[3]}"><a href="bbs_list.php?action=detial&&id={$data[0][1]}&&pageNum={$pageNum+3}&&idf=0&&snumber={$snumber}&&course_id={$course_id}">{$pageNum+3}</a></li>
				  <li class="{$sty[4]}"><a href="bbs_list.php?action=detial&&id={$data[0][1]}&&pageNum={$pageNum+4}&&idf=0&&snumber={$snumber}&&course_id={$course_id}">{$pageNum+4}</a></li>
				  <li class="{$sty[1]}"><a href="bbs_list.php?action=detial&&id={$data[0][1]}&&pageNum={$pageNum+1}&&idf=0&&snumber={$snumber}&&course_id={$course_id}">&raquo;</a></li>
				  <li class="{$sty[5]}"><a href="bbs_list.php?action=detial&&id={$data[0][1]}&&pageNum={$last}&&idf=0&&snumber={$snumber}&&course_id={$course_id}">最后页</a></li>
		  </ul>
		  </div>
</div>
        </div>
