    ...
    <div class="formbody">
		<div id="usual1" class="usual"> 
			...
			<div id="tab1" class="tabson">	
			   ...
			   <li class="{$sty[0]}"><a href="resources.php?action=list&&pageNum=1&&snumber={$snumber}&&course_id={$course_id}">首页</a></li>
			  <li class="{$sty[0]}"><a href="resources.php?action=list&&pageNum={$left}&&snumber={$snumber}&&course_id={$course_id}">&laquo;</a></li>
			  <li class="{$sty[6]}"><a href="resources.php?action=list&&pageNum={$pageNum}&&snumber={$snumber}&&course_id={$course_id}">{$pageNum}</a></li>
			  <li class="{$sty[1]}"><a href="resources.php?action=list&&pageNum={$pageNum+1}&&snumber={$snumber}&&course_id={$course_id}">{$pageNum+1}</a></li>
			  <li class="{$sty[2]}"><a href="resources.php?action=list&&pageNum={$pageNum+2}&&snumber={$snumber}&&course_id={$course_id}">{$pageNum+2}</a></li>
			  <li class="{$sty[3]}"><a href="resources.php?action=list&&pageNum={$pageNum+3}&&snumber={$snumber}&&course_id={$course_id}">{$pageNum+3}</a></li>
			  <li class="{$sty[4]}"><a href="resources.php?action=list&&pageNum={$pageNum+4}&&snumber={$snumber}&&course_id={$course_id}">{$pageNum+4}</a></li>
			  <li class="{$sty[1]}"><a href="resources.php?action=list&&pageNum={$pageNum+1}&&snumber={$snumber}&&course_id={$course_id}">&raquo;</a></li>
			  <li class="{$sty[5]}"><a href="resources.php?action=list&&pageNum={$last}&&snumber={$snumber}&&course_id={$course_id}">最后一页</a></li>
            </ul> 
			...
			<ul class="forminfo">
			<form id="fileUp_form" name="fileUp_form" method="post" action="resources.php?action=upload&&snumber={$snumber}&&course_id={$course_id}" enctype="multipart/form-data">	
