...
<body>
    ...
    <div class="mainindex">   
		...
		<div class="xline"></div>
<form name="xg_form" id="xg_form"  method="post" action="passWord.php?action=change" style="margin-left:350px">
	...
	<tr>
		<td width="22%">
			...
			<td>
		    <div align="left" >
		      <input name="count" id="count" type="text" class="dfinput" value="{$anumber}"  style="width:345px; " readonly />
		   </div>
